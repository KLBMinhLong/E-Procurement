...
- Việc nên ưu tiên tiếp theo: nối budget spent ledger cho E09 khi PO/invoice có budget reference rõ ràng, hoặc quay lại E07 manual/direct `POST /purchase-orders` khi approved-PR direct-PO source contract rõ ràng. User stories chi tiết đã có tại `docs/user-stories/E06-rfq-vendor.md`, `docs/user-stories/E09-invoice-payment.md`, `docs/user-stories/E10-budget-management.md`, và `docs/user-stories/E11-notification-realtime.md`.
