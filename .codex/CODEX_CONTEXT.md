...
- Việc nên ưu tiên tiếp theo trong E07: hoàn thiện PO create/edit/send/cancel workflow và phát `procurement.po.issued` cho Inventory/Notification. User stories chi tiết đã có tại `docs/user-stories/E06-rfq-vendor.md`, `docs/user-stories/E10-budget-management.md`, và `docs/user-stories/E11-notification-realtime.md`.
