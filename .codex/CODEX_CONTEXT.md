...
- Việc nên ưu tiên tiếp theo: quay lại E07 manual/direct `POST /purchase-orders` chỉ khi approved-PR direct-PO source contract rõ ràng, hoặc chuyển sang E09 Invoice & Payment / E12 Analytics theo tracker. User stories chi tiết đã có tại `docs/user-stories/E06-rfq-vendor.md`, `docs/user-stories/E10-budget-management.md`, và `docs/user-stories/E11-notification-realtime.md`.
