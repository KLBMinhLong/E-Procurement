...
| Frontend: Analytics dashboard/report export UI | ✅ | 2026-06-12: `/dashboard` thay mock bằng analytics dashboard thật, permission-aware tabs executive/manager/purchasing/requester, cycle-time/SLA KPI panels, async report export form + job refresh/download; i18n VI/EN. 2026-06-13: UI plan #8 slice 8a-8c hoàn thành chart dependency/foundation, tách `ep-dashboard-control-bar`, URL tab state, freshness/cache indicator, auto-refresh visible-only, department dropdown/fallback, executive monthly/category/SLA chart thật và semantic KPI icons; `npm run build` pass |
