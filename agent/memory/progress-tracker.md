...
| KPI/report export APIs | 🔄 | Async report export job API and KPI endpoint foundations added; Jasper/PDF/Excel worker, PR lifecycle projection, and SLA completion denominator remain follow-up |
