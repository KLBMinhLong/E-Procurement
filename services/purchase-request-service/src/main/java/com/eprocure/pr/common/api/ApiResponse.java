package com.eprocure.pr.common.api;
...
public record ApiResponse<T>(
    ...
    public static ApiResponse<Void> ok(String code, String message, String requestId) {
        return new ApiResponse<>(true, code, message, null, null, null, Instant.now(), requestId);
    }
